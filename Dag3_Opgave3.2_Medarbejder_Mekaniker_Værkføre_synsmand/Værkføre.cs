...
namespace Dag3_Opgave3._2_Medarbejder_Mekaniker_Værkføre_synsmand
{
    internal class Værkføre : Mekaniker
    {
        ...
        public Værkføre(CprNr cprNummer,string name, Adresse adress, int probationaryYear, double salary, int chosenJob, double salarySupplement) :base(cprNummer,name,adress,probationaryYear,salary)
        {
